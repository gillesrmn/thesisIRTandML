...
items_ga <- items_long %>%
  dplyr::select(EI12, EI17, EI20, EI22, EI27, EI31)
...
#### GA SHORT SCALE ####
model_ga <- "F =~ EI12 + EI17 + EI20 + EI22 + EI27 + EI31"
...
# correlation between short scale and Big5, compared to long scale
# Williams' (1959) test - if p > .05, short scale works similarly to long scale
test_03$EI_ga <- rowMeans(test_03[, c("EI12", "EI17", "EI20", "EI22", "EI27", "EI31")])
...
write.xlsx(result_transposed, file = "fit_indices_03_25.xlsx", rowNames = FALSE)